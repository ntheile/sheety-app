...
ignoreSheets = ["Product CA listing", "ProductSelector"]
rootKeys = ["Market Segment"]
rootProps = ["Trade Product"];
ignoreProps = [];
...
// 1 level deep
// jsonNesting = { 
//     name: "Trade Product", // root has no name
//     rootKeys: [
...
// jsonNesting = { 
//         name: "Trade Product", // root.products
//         rootKeys: null,
//         staticProps: [
//             {key: "@context", value: "https://schema.org/"},
//             {key: "@type", value: "Product"},
//             {key: "name", value: "${Trade Product}"},
//         ],
//         child: {
//             name: "properties", // root.products.properties
//             id: "https://dow.com/EMEAI/${Trade Product}",
